...
UPDATE Buildings SET PrereqTech = 'TECH_MYSTICISM' WHERE PrereqTech = 'TECH_ARCHERY';
UPDATE Buildings SET PrereqTech = 'TECH_SCIENTIFIC_METHOD' WHERE PrereqTech = 'TECH_PHYSICS';
